...
class Fund:
    ...
    def RAR(self, rank_date, rank_year, gamma=2):
        ...
        if pass_check:
            ...
            Sampler.truncate_by_quantile(rs)
...
class Sampler:
    ...
    @classmethod
    def check(cls, fund: Fund, rank_date, rank_year) -> bool:
        """
    ...
    # 自定义检查条件
    @classmethod
    def _is_weekly_freq(cls, fund: Fund, rank_date, rank_year) -> bool:
        """
    ...
    @classmethod
    def _has_data_in_last_month_of_every_season(cls, fund: Fund, rank_date, rank_year) -> bool:
        """
    ...
    @classmethod
    def _has_data_in_last_period(cls, fund: Fund, rank_date, rank_year) -> bool:
        """
    ...
    @classmethod
    def _has_data_in_first_period(cls, fund: Fund, rank_date, rank_year) -> bool:
        """
    ...
    @classmethod
    def _is_not_structured(cls, fund: Fund) -> bool:
        """
            判断是否满足条件——"属于非结构化"
...
class CalculateHelper:
    ...
    def calculate_rar_all(cls, rank_date):
        ...
        sql = "SELECT DISTINCT fund_id FROM fund_nv_data_standard WHERE statistic_date BETWEEN '{sd}' AND '{ed}' " \
    ...
    def calculate(cls, rank_date):
        sql = "DELETE FROM base.fund_rank WHERE statistic_date = '{sd}'".format(sd=str(rank_date))
