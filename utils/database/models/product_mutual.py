...
class IdMatch(mixin.TimeMixin, Base):
...
class OrgAssetScale(mixin.MultiSourceMixin, mixin.TimeMixin, Base):
...
class OrgPortfolioAsset(mixin.MultiSourceMixin, mixin.TimeMixin, Base):
...
class OrgPortfolioIndustry(mixin.MultiSourceMixin, mixin.TimeMixin, Base):
...
class OrgPositionStock(mixin.MultiSourceMixin, mixin.TimeMixin, Base):
...
class OrgShareholder(mixin.MultiSourceMixin, mixin.TimeMixin, Base):
...
# class DFundNv(mixin.MultiSourceMixin, mixin.TimeMixin, Base):
#     fund_id = Column("fund_id", String, primary_key=True)
#     fund_name = Column("fund_name", String)
#     statistic_date = Column("statistic_date", Date, primary_key=True)
#     nav = Column("nav", DECIMAL)
...
#
#
# class DFundYield(mixin.MultiSourceMixin, mixin.TimeMixin, Base):
#     fund_id = Column("fund_id", String, primary_key=True)
#     fund_name = Column("fund_name", String)
#     statistic_date = Column("statistic_date", Date, primary_key=True)
#     return_10k = Column("return_10k", DECIMAL, primary_key=True)
#     d7_return_a = Column("d7_return_a", DECIMAL, primary_key=True)
#
#
...
#
#
# class DFundAllocationAsset(mixin.MultiSourceMixin, mixin.TimeMixin, Base):
#     fund_id = Column("fund_id", String, primary_key=True)
#     fund_name = Column("fund_name", String)
#     data_source = Column("data_source", String)
...
#
#
# class DFundAllocationIndustry(mixin.MultiSourceMixin, mixin.TimeMixin, Base):
#     fund_id = Column("fund_id", String, primary_key=True)
#     fund_name = Column("fund_name", String)
#     data_source = Column("data_source", String)
#     statistic_date = Column("statistic_date", String)
